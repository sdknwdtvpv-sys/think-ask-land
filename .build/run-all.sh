...
NEEDS_SERVER="smoke games-pinyin-test pinyin-teach-test zili-test cause-test a4a5-ui-test profile-test store-test speech-test voice-test beacon-test report-test ux-regression profile-ui-test p0-visual-test p1-visual-test p2-visual-test p3-visual-test browser-test3"
