...
NEEDS_SERVER="self-read-test read-quiz-test record-test write-test quest-test pinyin-adv-test invariant-test smoke games-pinyin-test phrase-test pinyin-teach-test zili-test read-test parent-value-test emoji-test sound-test voice-config-test offline-test cause-test a4a5-ui-test profile-test store-test speech-test voice-test beacon-test report-test ux-regression profile-ui-test p0-visual-test p1-visual-test p2-visual-test p3-visual-test browser-test3"
