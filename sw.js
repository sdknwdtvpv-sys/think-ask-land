...
const ASSETS = [
  "./",
  "audio/config.json?v=1.13.0",
  "audio/tc-403000/index.json?v=1.13.0",
  "audio/tc-502007/index.json?v=1.13.0",
  "css/style.css?v=1.13.0",
  "css/style2.css?v=1.13.0",
  "css/v2.css?v=1.13.0",
  "data/chars-1.js?v=1.13.0",
  "data/chars-2.js?v=1.13.0",
  "data/chars-3.js?v=1.13.0",
  "data/chars-4.js?v=1.13.0",
  "data/chars-5.js?v=1.13.0",
  "data/chars-6.js?v=1.13.0",
  "data/chars.js?v=1.13.0",
  "data/emoji-extra.js?v=1.13.0",
  "data/hanzi-parts.js?v=1.13.0",
  "data/passages.js?v=1.13.0",
  "data/quests.js?v=1.13.0",
  "data/strokes.js?v=1.13.0",
  "fonts/kuaile-subset.woff2",
  "index.html",
  "js/app.js?v=1.13.0",
  "js/audio.js?v=1.13.0",
  "js/beacon.js?v=1.13.0",
  "js/contact.js?v=1.13.0",
  "js/games.js?v=1.13.0",
  "js/icons.js?v=1.13.0",
  "js/mascot.js?v=1.13.0",
  "js/pinyin.js?v=1.13.0",
  "js/report.js?v=1.13.0",
  "js/speech.js?v=1.13.0",
  "js/store.js?v=1.13.0",
  "js/sw-register.js?v=1.13.0",
  "js/ui.js?v=1.13.0",
  "js/views2.js?v=1.13.0",
  "js/views3.js?v=1.13.0",
  "js/views4.js?v=1.13.0",
  "js/writer.js?v=1.13.0",
  "privacy.html",
  "vendor/hanzi-writer.min.js?v=1.13.0"
];
